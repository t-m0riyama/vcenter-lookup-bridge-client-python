...
vm_detail_response_schema_instance = VmDetailResponseSchema.from_json(json)
# print the JSON string representation of the object
print(VmDetailResponseSchema.to_json())

# convert the object into a dict
vm_detail_response_schema_dict = vm_detail_response_schema_instance.to_dict()
# create an instance of VmDetailResponseSchema from a dict
vm_detail_response_schema_from_dict = VmDetailResponseSchema.from_dict(vm_detail_response_schema_dict)
```
