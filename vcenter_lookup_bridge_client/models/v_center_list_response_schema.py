...
class VCenterListResponseSchema(BaseModel):
    """
    ...
    results: List[VCenterResponseSchema] = Field(description="実際のデータ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [VCenterResponseSchema.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
