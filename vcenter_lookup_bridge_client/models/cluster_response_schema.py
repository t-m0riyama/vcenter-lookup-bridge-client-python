...
class ClusterResponseSchema(BaseModel):
    ...
    クラスタのレスポンススキーマ
    """ # noqa: E501
    hosts: List[StrictStr] = Field(description="クラスタに所属するホストの名前を示します。")
    name: StrictStr = Field(description="仮想マシンフォルダの名前を示します。")
    status: StrictStr = Field(description="クラスタのステータスを示します。")
    vcenter: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["hosts", "name", "status", "vcenter"]
