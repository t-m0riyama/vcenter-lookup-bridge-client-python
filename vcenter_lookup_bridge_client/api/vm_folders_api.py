...
class VmFoldersApi:
    ...
    def list_vm_folders(
        ...
        _param = self._list_vm_folders_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VmFolderListResponseSchema",
            '404': None,
    ...
    def list_vm_folders_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VmFolderListResponseSchema]:
        """List Vm Folders
    ...
    def _list_vm_folders_serialize(
        self,
        vm_folders,
        offset,
        max_results,
