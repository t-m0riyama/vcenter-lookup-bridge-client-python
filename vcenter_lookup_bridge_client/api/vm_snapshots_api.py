...
class VmSnapshotsApi:
    ...
    def get_vm_snapshots(
        ...
        vcenter: Annotated[StrictStr, Field(description="vCenterの名前を指定します。vCenter管理下の仮想マシン一覧を取得します。")],
        ...
        :param vcenter: vCenterの名前を指定します。vCenter管理下の仮想マシン一覧を取得します。 (required)
        :type vcenter: str
        ...
        _param = self._get_vm_snapshots_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VmSnapshotListResponseSchema",
            '404': None,
    ...
    @validate_call
    def get_vm_snapshots_with_http_info(
        self,
        vm_instance_uuid: Annotated[StrictStr, Field(description="インスタンスUUIDを指定します。※格納されている仮想マシンフォルダに関係なく、vmFolder属性はnullを返します。")],
        vcenter: Annotated[StrictStr, Field(description="vCenterの名前を指定します。vCenter管理下の仮想マシン一覧を取得します。")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="仮想マシンのスナップショットを取得する際の開始位置を指定します。")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VmSnapshotListResponseSchema]:
        """Get Vm Snapshots
    ...
    @validate_call
    def get_vm_snapshots_without_preload_content(
        self,
        vm_instance_uuid: Annotated[StrictStr, Field(description="インスタンスUUIDを指定します。※格納されている仮想マシンフォルダに関係なく、vmFolder属性はnullを返します。")],
        vcenter: Annotated[StrictStr, Field(description="vCenterの名前を指定します。vCenter管理下の仮想マシン一覧を取得します。")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="仮想マシンのスナップショットを取得する際の開始位置を指定します。")] = None,
    ...
    def _get_vm_snapshots_serialize(
        self,
        vm_instance_uuid,
        vcenter,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/vm_snapshots/{vm_instance_uuid}',
    ...
    def list_vm_snapshots(
        ...
        :param max_results: 仮想マシンのスナップショットを取得する際の最大件数を指定します。
        :type max_results: int
        :param vcenter: vCenterの名前を指定します。vCenter管理下の仮想マシン一覧を取得します。
        :type vcenter: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_vm_snapshots_serialize(
    ...
    def _list_vm_snapshots_serialize(
        self,
        vm_folders,
        offset,
        max_results,
