...
"""
ALARMS APIのテストで使用する期待するレスポンスデータ
"""

VALID_VCENTER = "simulator02"
VALID_BEGIN_TIME = "2025-06-01T08:00:00+09:00"
VALID_END_TIME = "2025-06-30T08:00:00+09:00"
VALID_BEGIN_TIME2 = "2025-06-01"
VALID_END_TIME2 = "2025-06-30"
...
INVALID_BEGIN_TIME = "2025/06/00T9"
INVALID_END_TIME = "2025/06/31T9"
INVALID_BEGIN_TIME2 = "2025/06/01"
INVALID_END_TIME2 = "2025/06/30"
...
# アラームリストのパラメータ(正常/絶対日付指定/タイムゾーン付き)
...
# アラームリストのパラメータ(正常/絶対日付指定/タイムゾーンなし)
...
# アラームリストのパラメータ(異常/絶対日付指定/タイムゾーン付き)
...
# アラームリストのパラメータ(異常/絶対日付指定/タイムゾーンなし)
...
# アラームリストのパラメータ(max_resultsが1000を超える)
...
# アラームリストのレスポンス例
EXPECTED_ALARM_LIST = json.loads(
    """
{
  "results": [
    {
      ...
      "alarmSource": "mini4.moriyama.internal",
      "status": "red",
      "createdTime": "2025-06-05T22:46:02.617751+00:00",
      "acknowledged": false,
    ...
    },
    {
      "name": "Host connection and power state",
      "description": "Default alarm to monitor host connection and power state",
      "alarmSource": "mini5.moriyama.internal",
      "status": "red",
      "createdTime": "2025-06-05T22:26:01.480000+00:00",
      "acknowledged": false,
      "acknowledgedTime": null,
      "vcenter": "simulator02",
      "datacenter": "KanagawaDC"
