...
class TestVmSnapshotsApi:
    ...
    def test_get_vm_snapshots_success(self, api_instance, test_dataset):
        """単一VMスナップショット取得の成功テスト"""
        # APIを呼び出し
        response = api_instance.get_vm_snapshots(**test_dataset.VALID_GET_PARAMETERS)
        ...
        for result, expected_result in zip(
            results, test_dataset.EXPECTED_SINGLE_VM_SNAPSHOTS
        ):
    ...
    def test_list_vm_snapshots_success(self, api_instance, test_dataset):
        ...
        # APIを呼び出し
        response = api_instance.list_vm_snapshots(**test_dataset.VALID_LIST_PARAMETERS)
        ...
        assert len(results) == len(
            test_dataset.EXPECTED_MULTI_VM_SNAPSHOT_LIST["results"]
        )
    ...
    def test_list_vm_snapshots_with_invalid_max_results(
        self, api_instance, test_dataset
    ):
    ...
    def test_list_vm_snapshots_with_invalid_offset(self, api_instance, test_dataset):
    ...
    def test_list_vm_snapshots_with_pagination(self, api_instance, test_dataset):
        ...
        # 期待結果との比較
        expected_pagination = test_dataset.EXPECTED_MULTI_VM_SNAPSHOT_LIST["pagination"]
