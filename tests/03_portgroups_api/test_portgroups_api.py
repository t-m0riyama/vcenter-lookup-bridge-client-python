...
class TestPortgroupsApi:
    ...
    def test_list_portgroups_success(self, api_instance, test_dataset):
        """データストアリスト取得の成功テスト"""
        # APIを呼び出し
        response = api_instance.list_portgroups(**test_dataset.VALID_LIST_PARAMETERS)
        ...
        assert len(results) == len(test_dataset.EXPECTED_PORTGROUPS_LIST["results"])
        ...
        for result, expected_result in zip(
            results,
            test_dataset.EXPECTED_PORTGROUPS_LIST["results"],
        ):
    ...
    def test_list_portgroups_success_multi_tags(self, api_instance, test_dataset):
        """ポートグループリスト取得の成功テスト"""
        # APIを呼び出し
        ...
        assert len(results) == len(
            test_dataset.EXPECTED_PORTGROUPS_LIST_MULTI_TAGS["results"]
        )
    ...
    def test_list_portgroup_not_found_with_invalid_tag_category(
    ...
    def test_list_portgroup_not_found_with_invalid_tag(
        self, api_instance, test_dataset
    ):
    ...
    def test_list_portgroup_not_found_with_invalid_vcenter(
        self, api_instance, test_dataset
    ):
    ...
    def test_list_portgroups_with_invalid_max_results(self, api_instance, test_dataset):
    ...
    def test_list_portgroups_with_invalid_offset(self, api_instance, test_dataset):
    ...
    def test_list_portgroups_with_pagination(self, api_instance, test_dataset):
        ...
        # 期待結果との比較
        expected_pagination = test_dataset.EXPECTED_PORTGROUPS_LIST["pagination"]
